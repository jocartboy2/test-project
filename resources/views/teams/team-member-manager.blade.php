                                        ...
                                        <div class="{{ isset($addTeamMemberForm['role']) && $addTeamMemberForm['role'] !== $role->key ? 'opacity-50' : '' }}">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                @if ($addTeamMemberForm['role'] == $role->key)
                                                    <svg class="ml-2 mb-2 font-medium leading-tight text-lg w-5 text-green-400" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                                @endif
                                            </div>
